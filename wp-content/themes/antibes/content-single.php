...
<article id="post-<?php the_ID(); ?>" class="readWidth blog-article">
	...
	<footer class="entry-footer">
		<?php
			...
			if ( ! _mbbasetheme_categorized_blog() ) {
				...
				if ( '' != $tag_list ) {
					$meta_text = __( 'Discover more in %1$s and tagged %2$s. Bookmark the <a href="%3$s" rel="bookmark">permalink</a>.', '_mbbasetheme' );
				} else {
					$meta_text = __( 'Discover more in %1$s. Bookmark the <a href="%3$s" rel="bookmark">permalink</a>.', '_mbbasetheme' );
				}
